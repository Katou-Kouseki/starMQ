...
INSERT INTO `star_admin` (`id`, `nickname`, `username`, `password`, `email`, `qq`, `salt`, `token`, `login_ip`, `login_time`) VALUES
(1, '深秋.', 'admin', '45c28e4a98fa051b1f3fa37f2c0c1e84826c3460', 'i@kain8.cn', 1361582519, 'starMQ-Pay_2.0_kaindev8-single-user', '', '', 0);
...
INSERT INTO `star_config` (`key`, `val`) VALUES
('app_heart', ''),
('app_status', '0'),
('appid', '1000'),
('appkey', ''),
